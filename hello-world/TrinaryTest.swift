...
class TrinaryTest: XCTestCase {
    ...
    func testTrinary12IsDecimal5() {
        XCTAssertEqual(5, Int(Trinary("12")))
    }
    
    func testTrinary20IsDecimal6() {
        XCTAssertEqual(6, Int(Trinary("20")))
    }
    
    func testTrinary21IsDecimal7() {
        XCTAssertEqual(7, Int(Trinary("21")))
    }
    
    func testTrinary22IsDecimal8() {
        XCTAssertEqual(8, Int(Trinary("22")))
    }
